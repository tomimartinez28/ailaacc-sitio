...
import { CIFRAS, SERVICIOS } from '../../../data/sitio.js';
  ...
  return (
    <section className="hero" id="inicio">
      <div className="wrap hero-inner">
        ...
        <p className="lede">A.I.L.A.A.C.C. brinda educación terapéutica, integración escolar, estimulación temprana, transporte adaptado y diagnóstico interdisciplinario, con equipos presentes en seis localidades del Chaco.</p>
        ...
        <p className="hero-trust">
          {CIFRAS.map(([fuerte, resto]) => (
            <span key={fuerte}><Icon name="check" /><b>{fuerte}</b>{resto && ` ${resto}`}</span>
          ))}
        </p>
      </div>
